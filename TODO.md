...
DONE:
x provide utility functions so that the JUnit test code is more readable
x improve compiler error messages
x print coloured text to make developers' life easier
